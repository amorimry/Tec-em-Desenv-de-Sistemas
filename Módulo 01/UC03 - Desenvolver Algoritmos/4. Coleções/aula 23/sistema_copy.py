...
while True:
    ...
    if opcao1 == "1":
        ...
        while True:
            ...
            remover_func = int(input("Digite o número do funcionário que deseja remover: "))

            func_escolhido = funcionarios[remover_func-1]

            print(f"Funcionário: {func_escolhido["Nome"].title()}")
            print(f"Idade: {func_escolhido["Idade"]}")
            print(f"CPF: {func_escolhido["CPF"]}")
            print(f"Cargo: {func_escolhido["Cargo"].title()}")
            print(f"Salário: R$ {func_escolhido["Salário"]:.2f}")
